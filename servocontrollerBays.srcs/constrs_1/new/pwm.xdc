...
set_property PACKAGE_PIN U2 [get_ports {Anode_Activate_0[0]}]                    
   set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Activate_0[0]}]
set_property PACKAGE_PIN U4 [get_ports {Anode_Activate_0[1]}]                    
   set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Activate_0[1]}]
set_property PACKAGE_PIN V4 [get_ports {Anode_Activate_0[2]}]               
   set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Activate_0[2]}]
set_property PACKAGE_PIN W4 [get_ports {Anode_Activate_0[3]}]          
   set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Activate_0[3]}]
##Buttons
#set_property PACKAGE_PIN U18 [get_ports clr_0]						
	#set_property IOSTANDARD LVCMOS33 [get_ports clr_0]
