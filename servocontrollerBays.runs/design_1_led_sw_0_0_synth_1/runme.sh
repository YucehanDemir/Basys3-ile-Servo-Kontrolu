...
HD_PWD='C:/Users/yucehan/Desktop/servocontrollerBays/servocontrollerBays.runs/design_1_led_sw_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_led_sw_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_led_sw_0_0.tcl
